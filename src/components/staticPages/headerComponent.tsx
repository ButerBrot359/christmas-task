...
import Magnifier from '../../images/svg/search.svg'
import Cross from '../../images/svg/cross.png'

export const HeaderComponent: React.FC = (data) => {
  return (
    <>
      <header className="header">
        <div className="header-container">
          ...
          <div className="header-controls">
            ...
            <SelectedToysNum setSelect={data.amountOfSelected} />
          </div>
        </div>
      </header>
    </>
...
const InputField: React.FC = ({ updateSearch, searchField }) => (
  <>
    <input
      type="text"
...
const SelectedToysNum: React.FC = (data) => (
  <>
    <div className="selected">
      <div className="toy-head"></div>
      <span>{data.setSelect}</span>
    </div>
  </>
)
